...
@section('content')
<div class="container">
    <a href="{{ route('genres.index') }}" class="btn btn-link text-muted px-0 mb-3">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="bg-secondary bg-opacity-10 rounded d-flex align-items-center justify-content-center me-3" style="width: 80px; height: 80px">
                            <i class="bi bi-bookmark text-muted" style="font-size: 2rem;"></i>
                        </div>
                        <div>
                            <h1 class="h2 mb-1">{{ $genre->name }}</h1>
                            <p class="text-muted mb-0">{{ $genre->books->count() }} {{ Str::plural('Book', $genre->books->count()) }}</p>
                        </div>
                    </div>

                    <div class="d-flex gap-2">
                        <a href="{{ route('genres.edit', $genre->id) }}" class="btn btn-outline-secondary">
                            <i class="bi bi-pencil"></i> Edit Genre
                        </a>
        ...
        <div class="col-md-12">
            <h2 class="h4 mb-4">Books in {{ $genre->name }}</h2>
                        ...
                        <div class="card h-100 book-card">
                            <div class="card-body">
                                ...
                                <div class="text-muted mb-3">
                                    by <a href="{{ route('authors.show', $book->author->id) }}" class="text-decoration-none text-dark">
                                        {{ $book->author->name }}
                                    </a>
                                </div>
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center my-5">
                            ...
                            <p class="text-muted mb-4">There are no books in this genre yet.</p>
